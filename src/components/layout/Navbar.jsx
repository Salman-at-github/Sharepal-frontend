...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 z-[990] flex justify-between items-center py-4 px-6 border-b-2 border-gray-300 w-full bg-white shadow-md overflow-x-hidden">
      ...
      />
      <div
        className={`w-80 select-none h-screen fixed top-0 right-0 border-l shadow-md border-gray-300 bg-white flex justify-start items-start flex-col px-10 gap-6 transition-all duration-700 ${
